...
func (u *UserMgo) PageFindUser(ctx context.Context, pagination pagination.Pagination) (count int64, users []*relation.UserModel, err error) {
	return mgoutil.FindPage[*relation.UserModel](ctx, u.coll, bson.M{"app_manger_level": 0}, pagination)
}
